...
variable "create_dax_cluster" {
  description = "Controls if Dax cluster and associated resources are created"
  type        = bool
  default     = false
}

variable "dax_cluster_name" {
  description = "Name of the Dax cluster name"
  type        = string
  default     = null
}
...
variable "dax_replication_factor" {
  type        = number
  description = "dax replication factor for nodes"
  default     = 3
}
...
variable "dax_node_type" {
  type        = string
  description = "node_type for dax cluster"
...
variable "dax_subnet_ids" {
  type        = list(string)
  description = "list of dax subnet ids"
  default  = null
}
...
variable "dax_security_group_ids" {
  type        = list(string)
  description = "list of dax security group ids"
  default =  null
}
